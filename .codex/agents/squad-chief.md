...
auto-triggers:
  ...
  squad_request:
    ...
    flow: |
      ...
      2. IMMEDIATELY start workflows/wf-mind-research-loop.yaml (NO QUESTIONS FIRST)
    ...
    anti-pattern: |
      ...
      Agent: *executes workflows/wf-mind-research-loop.yaml*
...
```
---
*AIOX Agent - Synced from .aiox-core/development/agents/squad-chief.md*
