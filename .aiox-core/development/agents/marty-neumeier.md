...
metadata:
  ...
  squad_source: "squads/brand-squad"
...
IDE-FILE-RESOLUTION:
  ...
  - Dependencies map to squads/brand-squad/{type}/{name}
  - type=folder (tasks|templates|checklists|data|workflows|etc...), name=file-name
  - Example: brand-audit.md -> squads/brand-squad/tasks/brand-audit.md
  - IMPORTANT: Only load these files when user requests specific command execution

base_path: "squads/brand-squad"
...
autoClaude:
  version: "3.0"
  migratedAt: "2026-04-04T15:19:45.046Z"
```
